...
export class ShopifyStoreEnum1661687936031 implements MigrationInterface {
    name = 'ShopifyStoreEnum1661687936031'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."log_store_enum" RENAME TO "log_store_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."log_store_enum" AS ENUM('zalando', 'snipes', 'solebox', 'lvr', 'kith', 'supreme', 'New Balance', 'Shopify')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."checkout_store_enum" AS ENUM('zalando', 'snipes', 'solebox', 'lvr', 'kith', 'supreme', 'New Balance', 'Shopify')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."checkout_store_enum_old" AS ENUM('zalando', 'snipes', 'solebox', 'lvr', 'kith', 'supreme', 'New Balance')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."log_store_enum_old" AS ENUM('zalando', 'snipes', 'solebox', 'lvr', 'kith', 'supreme', 'New Balance')`);
